      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        ...
        <div>
          ...
          <p className="mt-0.5 text-xs text-gray-500">
            Create a new asset record in the Asset Library
          </p>
        </div>
      </div>
              ...
              <div className="ml-2">
                ...
                <div className="mt-0.5 text-xs text-blue-800">
                  <p>
                    ...
                    After creating this asset, link it to processes to establish its criticality tier.
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[10px] text-gray-500">Select type first, then category</p>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-1.5 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900 disabled:bg-gray-100 disabled:cursor-not-allowed"
                    >
                    ...
                    <p className="mt-0.5 text-[10px] text-gray-500">
                      {!formData.assetTypeId ? 'Select asset type first' : 'Optional - can be assigned later'}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900"
                      placeholder="e.g., Dell, Oracle, Cisco"
                    />
                  </div>
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    <p className="mt-0.5 text-[10px] text-gray-500">Person responsible for the asset</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900"
                      placeholder="Technical contact name or email"
                    />
                    <p className="mt-0.5 text-[10px] text-gray-500">Person to contact for technical issues</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-sm">
              ...
              <div className="p-4">
                <textarea
                  ...
                  className="w-full px-3 py-1.5 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900"
                  placeholder="Any additional notes, configuration details, or special considerations..."
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                ...
                disabled={saving}
                className="px-3 py-1.5 border border-gray-300 rounded-sm text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
