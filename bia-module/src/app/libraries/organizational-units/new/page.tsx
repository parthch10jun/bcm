...
export default function NewOrganizationalUnitPage() {
  ...
  // Validation: Check if unit name already exists under selected parent
  ...
  // Validation: Check if unit code already exists globally
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call API to create organizational unit
      ...
      const errorMessage = error.message || 'Failed to create organizational unit. Please try again.';
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    if (type === 'checkbox') {
      ...
      // Trigger validation on blur for unit name
      if (name === 'parentUnitId') {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        ...
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Add Organizational Unit</h1>
          <p className="mt-0.5 text-xs text-gray-500">
            Create a new unit in the organizational hierarchy
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto px-6 py-4">
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {validationErrors.unitCode ? (
                    ...
                    <p className="mt-0.5 text-[10px] text-gray-500">Leave empty to auto-generate</p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="mt-0.5 text-[10px] text-gray-500">
                    {hasRootUnit
                      ? 'A top-level organization already exists. Please select a parent unit.'
                      : 'Select where this unit should be placed in the hierarchy'}
                  </p>
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-sm">
            <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
              <h3 className="text-xs font-medium text-gray-700 uppercase tracking-wider">Metrics (Optional)</h3>
            </div>
            <div className="p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
