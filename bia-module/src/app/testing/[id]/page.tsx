...
const mockTests: Record<string, TestRecord> = {
  ...
  'ITSCM-T-001': {
    id: 'ITSCM-T-001',
    name: 'Core Insurance Platform Failover',
    type: 'Full Simulation',
    category: 'bcp',
    status: 'Completed',
    workflowStage: 'complete',
    linkedBCP: 'BCP-001',
    linkedBCPName: 'Core Insurance Platform',
    owner: 'Michael Schmidt',
    scenario: 'Primary Datacenter Outage',
    strategy: 'DR Site Failover',
    createdDate: '2024-02-15',
    lastUpdated: '2024-03-10',
    plannedDate: '2024-03-10',
    completedDate: '2024-03-10',
    description: 'Full disaster recovery test validating failover of core insurance platform to DR site, including database replication, application recovery, and business process validation.',
    nextAction: 'View Report',
    planProgress: 100,
    reportProgress: 100,
    pendingApproval: null,
  ...
  'ITSCM-T-002': {
    id: 'ITSCM-T-002',
    name: 'Oracle Database Recovery Test',
    type: 'Component Test',
    category: 'bcp',
    status: 'In Progress',
    workflowStage: 'executing',
    linkedBCP: 'BCP-002',
    linkedBCPName: 'Database Infrastructure',
    owner: 'Anna Schmidt',
    ...
    completedDate: null,
    description: 'Testing Oracle database recovery procedures including RMAN backup restoration and point-in-time recovery.',
    nextAction: 'Execute Recovery Phase',
    planProgress: 100,
    reportProgress: 45,
    pendingApproval: null,
    evidenceCount: 8,
  ...
  'ITSCM-T-003': {
    id: 'ITSCM-T-003',
    name: 'Network Infrastructure Failover',
    type: 'Component Test',
    category: 'bcp',
    status: 'Plan Approved',
    workflowStage: 'approved',
    linkedBCP: 'BCP-003',
    linkedBCPName: 'Network Infrastructure',
    owner: 'Tom Harris',
    scenario: 'Core Router Failure',
    strategy: 'Redundant Path Activation',
    createdDate: '2024-11-10',
    lastUpdated: '2024-11-20',
    plannedDate: '2024-12-01',
    completedDate: null,
    description: 'Testing network failover capabilities including BGP routing changes and load balancer reconfiguration.',
    nextAction: 'Schedule Test Execution',
    planProgress: 100,
    reportProgress: 0,
    pendingApproval: null,
    evidenceCount: 0,
  ...
  'ITSCM-T-004': {
    id: 'ITSCM-T-004',
    name: 'Ransomware Response Drill',
    type: 'Full Simulation',
    category: 'bcp',
    status: 'Completed',
    workflowStage: 'complete',
    linkedBCP: 'BCP-006',
    linkedBCPName: 'Cyber Incident Response',
    owner: 'David Klein',
    scenario: 'Ransomware Attack',
    strategy: 'Isolation and Recovery',
    createdDate: '2024-09-20',
    lastUpdated: '2024-10-15',
    plannedDate: '2024-10-15',
    completedDate: '2024-10-15',
    description: 'Full-scale ransomware incident response drill including system isolation, forensic analysis, and clean recovery from backups.',
    nextAction: 'Review Lessons Learned',
    planProgress: 100,
    reportProgress: 100,
    pendingApproval: null,
    evidenceCount: 24,
  ...
  'ITSCM-T-005': {
    id: 'ITSCM-T-005',
    name: 'Full DR Site Activation - Munich',
    type: 'Full Simulation',
    category: 'bcp',
    status: 'Plan Approved',
    workflowStage: 'approved',
    linkedBCP: 'BCP-001',
    linkedBCPName: 'Enterprise DR Plan',
    owner: 'Klaus Weber',
    scenario: 'Complete Site Loss',
    strategy: 'Full DR Site Activation',
    createdDate: '2024-11-01',
    lastUpdated: '2024-11-22',
    plannedDate: '2024-12-15',
    completedDate: null,
    description: 'Comprehensive DR test activating all critical systems at Munich DR site, including infrastructure, applications, and business processes.',
    nextAction: 'Coordinate Team Schedules',
    planProgress: 100,
    reportProgress: 0,
    pendingApproval: null,
    evidenceCount: 0,
  ...
  'ITSCM-T-006': {
    ...
    strategy: 'Secondary Gateway Activation',
    createdDate: '2024-11-15',
    lastUpdated: '2024-11-28',
    plannedDate: '2024-12-05',
    completedDate: null,
    description: 'Testing failover to backup payment gateway provider with transaction validation.',
    nextAction: 'Awaiting Plan Approval',
    planProgress: 100,
    reportProgress: 0,
    pendingApproval: 'plan',
  ...
  'ITSCM-T-007': {
    id: 'ITSCM-T-007',
    name: 'CRM System Recovery',
    type: 'Component Test',
    category: 'bcp',
    status: 'Draft',
    workflowStage: 'draft',
    linkedBCP: 'BCP-005',
    linkedBCPName: 'CRM Platform',
    owner: 'Emma Weber',
    scenario: 'CRM System Failure',
    strategy: 'VM Snapshot Recovery',
    createdDate: '2024-11-20',
    lastUpdated: '2024-11-25',
    plannedDate: '2024-12-20',
    completedDate: null,
    description: 'Testing CRM system recovery from VM snapshots with data integrity validation.',
    nextAction: 'Complete Test Plan',
    planProgress: 35,
    reportProgress: 0,
    pendingApproval: null,
...
function ReportTab({ test }: { test: TestRecord }) {
  ...
  const getReportSummary = () => {
    ...
    return {
      ...
      finalResult: test.reportProgress === 100 ? 'pass' as const : null,
      attendees: 6,
      plannedAttendees: 8,
      findings: 3,
      issues: 2,
